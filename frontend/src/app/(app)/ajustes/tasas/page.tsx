...
export default function Tasas() {
  const qc = useQueryClient(); const tasas = useQuery({ queryKey: ["ajustes", "tasas"], queryFn: () => api.get<Tasa[]>("/ajustes/tasas", { limite: 150 }), staleTime: 60_000 });
